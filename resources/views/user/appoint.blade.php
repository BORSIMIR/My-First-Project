      ...
      <form class="main-form" action="{{url('appointment',$doctors->id)}}" method="POST">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-12 py-2 wow fadeInRight" data-wow-delay="300ms">
             ...
             <select style="width: 347px" name="choose"  id="choose" class="choose">

            <option value="0" selected disabled>Choose an Appointment</option>
            <option value="Physical">Physical Consultation Appointment</option>
            <option value="Virtual">Virtual Consultation Appointment</option>
...
<script>
  $("#choose").change(function()
            ...
            if($(this).val() == "Physical")
        {
            ...
            $(".prod_price4").prop('selectedIndex',0);
                        $(".prod_price5").hide();
            $(".prod_price6").hide();
            $(".prod_price7").hide();
            $(".prod_price8").hide();
