...
class AdminController extends Controller
{
    ...
    public function showappointment()
    {
        ...
        $data=appointment::whereNot('Type','Physical')->get();
    ...
    public function showappointment1()
    {
        ...
        $data=appointment::whereNot('Type','Virtual')->get();

        return view('admin.showappointment1',compact('data'));
...
////////////////////////TOTAL USER/////////////////////////////////////
    ...
    public function updatetotaluser($id)
    {
        ...
        return view('admin.updatetotaluser',compact('data','doctor'));
    ...
    public function edittotaluser(request $request, $id)
    {
        ...
        $health->appointment=$request->appointment;
...
////////////////////////PRINT/////////////////////////////////////
    ...
    public function export_appoint_pdf()
    {
        ...
        $appoint=appointment::whereNot('Type','Virtual')->get();
        $pdf=PDF::loadview('admin.pdf1',['appoint'=>$appoint]);
        return $pdf->stream();

        return $pdf->download('Patient Appointment Data (Physical).pdf');

    }

    public function export_appoint_pdf11()
    {

        $appoint=appointment::whereNot('Type','Physical')->get();
        $pdf=PDF::loadview('admin.pdf11',['appoint'=>$appoint]);
        return $pdf->stream();

        return $pdf->download('Patient Appointment Data (Virtual).pdf');
